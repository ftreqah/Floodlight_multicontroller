...
public class Device implements IDevice {
    ...
    protected static Logger logger = LoggerFactory.getLogger(DataTracker.class);
    protected static List<IPv4Address> IPs= new ArrayList<IPv4Address>();
    ...
    public static Producer netClient= new Producer();
	protected conf myConf= new conf();
    ...
    public IPv4Address[] getIPv4Addresses() {
        ...
        for (Entity e : entities) {
            ...
            if(!IPs.contains(e.getIpv4Address()) && e.getIpv4Address()!= IPv4Address.NONE){
            	IPs.add(e.getIpv4Address());
            logger.info("New device connected "+e.getIpv4Address());	
            msg = "New remote device connected "+e.getIpv4Address()+"\n";
            writeObject(msg);
            }
